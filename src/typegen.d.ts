...
export type ConfigNames = 'pleisto/imports/rules' | 'pleisto/javascript/setup' | 'pleisto/javascript/rules' | 'pleisto/javascript/disables/cli' | 'pleisto/node/rules' | 'pleisto/perfectionist/setup' | 'pleisto/react/setup' | 'pleisto/react/rules' | 'pleisto/test/setup' | 'pleisto/test/rules' | 'pleisto/regexp/rules' | 'pleisto/typescript/setup' | 'pleisto/typescript/parser' | 'pleisto/typescript/rules' | 'pleisto/typescript/disables/dts' | 'pleisto/typescript/disables/test' | 'pleisto/typescript/disables/cjs' | 'pleisto/unicorn/rules'
